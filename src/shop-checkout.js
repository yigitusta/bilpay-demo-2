...
class ShopCheckout extends PolymerElement {
                ...
                <section>
                  ...
                  <div hidden$="[[!hasBillingAddress]]">
                    <div class="row input-row">
                      <shop-input>
                        <input type="text" id="billAddress" name="billAddress" pattern=".{5,}"
                            placeholder="Address"  $="[[hasBillingAddress]]"
                    ...
                    <div class="row input-row">
                      <shop-input>
                        <input type="text" id="billCity" name="billCity" pattern=".{2,}"
                            placeholder="City"  $="[[hasBillingAddress]]"
                    ...
                    <div class="row input-row">
                      <shop-input>
                        <input type="text" id="billState" name="billState" pattern=".{2,}"
                            placeholder="State/Province"  $="[[hasBillingAddress]]"
                      ...
                      <shop-input>
                        <input type="text" id="billZip" name="billZip" pattern=".{4,}"
                            placeholder="Zip/Postal Code"  $="[[hasBillingAddress]]"
                    ...
                    <div class="column">
                      ...
                      <shop-select>
                        <select id="billCountry" name="billCountry"  $="[[hasBillingAddress]]"
                  ...
                  <dom-repeat items="[[cart]]" as="entry">
                    <template>
                      <div class="row order-summary-row">
                        ...
                        <div id="total2">[[_getEntryTotal(entry)]]</div>
                      </div>
                    </template>
                  </dom-repeat>
  ...
  _submit(e) {
    ...
    bilpay.createTransaction(Number(localStorage.getItem("total").slice(4)), "Hello World")
      .then((transaction) => {
  ...
  _formatPrice(total) {
    return isNaN(total) ? '' : 'BLC ' + total.toFixed(2);
  }

  _getEntryTotal(entry) {
    const anotherTotal = this._formatPrice(entry.quantity * entry.item.price);
    localStorage.setItem("total", anotherTotal);
    return anotherTotal;
  }
